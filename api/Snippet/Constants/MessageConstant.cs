namespace Snippet.Constants
{
    public static class MessageConstant
    {
        ...
        public static readonly (string, string) FOLDER_INFO_0001 = ("FOLDER_INFO_0001", "文件夹创建成功！");
        public static readonly (string, string) FOLDER_INFO_0002 = ("FOLDER_INFO_0002", "文件夹删除成功！");
        public static readonly (string, string) FOLDER_INFO_0003 = ("FOLDER_INFO_0003", "文件夹更新成功！");

        public static readonly (string, string) FOLDER_ERROR_0001 = ("FOLDER_ERROR_0001", "无法删除，文件夹包含文件！");
        public static readonly (string, string) FOLDER_ERROR_0002 = ("FOLDER_ERROR_0002", "上级文件夹不能指定为自身！");

        #endregion FolderController

        #region RecycleController

        public static readonly (string, string) ERCYCLE_INFO_0001 = ("ERCYCLE_INFO_0001", "文档已恢复！");
        public static readonly (string, string) ERCYCLE_INFO_0002 = ("ERCYCLE_INFO_0002", "文档及所有历史记录已删除！");

        #endregion RecycleController
